...
Собираются тексты из научного журнала неопубликованные с меткой 0 и опубликованные с меткой 1. Далее все тексты отдаются на разбор нейросети. Внутренняя структура нейросети распознает путь неопубликованной статьи к 0, а опубликованной к 1 и обучает веса проходитть к нужным выходам 0 или 1. Но для новой статьи можно выдавать не решение, а вероятность, то есть число от 0 до 1 принадлежности статьи к непубликуемым или публикуемым. Решение за редактором.
