...
> 
> Cкритпы *Python* для обучения с использованием архитектур полносвязной нейронной сети (*FFNN*), *Bidirectional Encoder Representations from Transformers* (*BERT*) и *Longformer* приведены в репозитории в папке `train_and_inference_model`.
