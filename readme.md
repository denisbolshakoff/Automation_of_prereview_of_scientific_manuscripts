...
Собираются тексты из научного журнала: неопубликованные с меткой 0 и опубликованные с меткой 1. Далее все тексты разбираются по словам и большой вектор где в качестве координаты присутствие слова есть 1 а отсутствие слова есть 0 отдаются на разбор нейросети. Внутренняя структура нейросети распознает путь неопубликованной рукописи к выходу с числом 0, а опубликованной к выходу с числом 1 и обучает веса (w и h на картинке ниже) проходить к нужным выходам 0 или 1. Но для новой статьи можно выдавать не решение, а вероятность, то есть число от 0 до 1 принадлежности рукописи к непубликуемым или публикуемым. Решение за редактором.
