...
1. Собираются тексты из научного журнала: неопубликованные с меткой 0 и опубликованные с меткой 1. 
2. Тексты каждой рукописи разбираются по словам. 
3. Каждая рукопись преобразуется в большой вектор, где в качестве координаты - присутствие слова из большого словаря собранного со всех рукописей, а размерность - размер словаря. 
4. В координату вектора каждой рукописи ставится 1 если слово есть в рукописи и 0 в обратном случае. 
5. Полученные таким образом вектора отдаются на разбор нейросети. 
6. Внутренняя структура нейросети распознает путь неопубликованной рукописи к выходу с числом 0, а опубликованной к выходу с числом 1 и обучает веса (w картинке ниже) проходить к нужным выходам 0 или 1 рукописям с соответствующими метками (0 или 1). 
7. Для новой статьи можно выдавать не решение (0 или 1), а вероятность, то есть число от 0 до 1 принадлежности рукописи к непубликуемым или публикуемым. 
